...
$stmt = $pdo->prepare('SELECT * FROM prof ORDER BY id_prof LIMIT :current_page, :record_per_page');
...
<div class="content read">
	<table>
        ...
        <tbody>
            ...
            <tr>
                <td><?=$contact['id_prof']?></td>
                <td><?=$contact['pengirim']?></td>
                <td><?=$contact['email']?></td>
                <td><?=$contact['isi']?></td>
                <td><?=$contact['tanggal']?></td>
                <td class="actions">
                    <a href="update.php?id=<?=$contact['id_prof']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
