  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link text-dark" href="admin.php">Home <span class="sr-only">(current)</span></a>
      </li>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <a href="del2.php?id=<?=$contact['id_user']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
