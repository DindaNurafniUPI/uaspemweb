...
<main role="main" class="container">
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        <h2 class="blog-post-title">Kabupaten Kepulauan Seribu Helatkan Rakor Penambahan Wilayah

</h2>
        <p class="blog-post-meta"> Kategori : Pemerintahan | Reporter : Sudin Kominfotik Kab. Adm. Kepulauan Seribu | Editor : Petrus Ardianto | 13 Dec 2021 | Dilihat : 20

sumber: https://pulauseribu.jakarta.go.id</a></p>

        <hr>
        <p> Kabupaten Kepulauan Seribu melakukan rapat koordinasi (Rakor) terkait Usulan Penambahan Wilayah Pulau C, D, G dan sebagai wilayah di Gedung Mitra Praja, Jakarta, Senin (13/12/2021).
...
"Selain itu, peraturan Gubernur Provinsi DKI Jakarta No. 58 tahun 2018 tentang Pembentukan, Organisasi dan Tata Kerja Badan Koordinasi Pengelolaan Reklamasi Pantai Utara Jakarta dan Peraturan Gubernur Nomor 121 tahun 2012 Tentang Penataan Ruang Kawasan Reklamasi Pantai Utara Jakarta," tandasnya.</p>
        <img src="img/1aja.jpg" width="750" height="450" align="center">
        </ul>
        <p></p>
        <ol>
        </ol>
